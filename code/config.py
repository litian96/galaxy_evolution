...
train_arg.add_argument('--ae_lr', type=float, default=0.00008)
...
train_arg.add_argument('--weight_', type=float, default=0.0)

# Misc
misc_arg = add_argument_group('Misc')
misc_arg.add_argument('--load_path', type=str, default='')
misc_arg.add_argument('--log_step', type=int, default=5)
